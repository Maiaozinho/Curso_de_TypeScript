...
function sum(a: number | string, b: number | string){
    ...
    if(typeof a === "string" && typeof b === "string"){
        ...
        console.log(a + b)
        else console.log("Por favor, confira os dados inseridos")
}
...
// 4 - operador in
class Dog { // criando um cachorro
    name //esse eh o nome do cachorro
    breed // essa eh a raca do cachorro

    constructor(name: string, breed?: string) { // definindo um molde para o cachorro
...
function ShowDogDetails(dog: Dog) { // criando uma funcao para dizer a raca do cachorro
